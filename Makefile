...
build: check-go check-git
	...
	go build -o polygon-edge -ldflags="\
    	-X 'github.com/Infinity-Green/inf/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/Infinity-Green/inf/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/Infinity-Green/inf/versioning.Branch=$(BRANCH)'\
		-X 'github.com/Infinity-Green/inf/versioning.BuildTime=$(TIME)'" \
	main.go
